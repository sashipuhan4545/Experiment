...
public class Locators_CallSetting_o {
	private static AndroidDriver<AndroidElement> aDriver;

	public Locators_CallSetting_o(AndroidDriver<AndroidElement> aDriver) {
	...
	public static WebElement blackcontactList;
	...
	public static WebElement firstblackno;
	...
	public static WebElement whitecontactList;
	...
	@AndroidFindBy(xpath="//android.widget.ImageView[@resource-id='com.android.server.telecom:id/delete_blocked_number']")
	public static WebElement deleteblockBtninContact; 
	...
	public static WebElement smsfirstmsg;
	...
	public static WebElement quickresponseedittxt;

	@AndroidFindBy(xpath="//android.widget.RelativeLayout[@index='1']/../..//android.widget.LinearLayout[@index='1']")
	public static WebElement quickresponsemsg;
	
	@AndroidFindBy(xpath="//android.widget.ImageButton[@resource-id='com.android.dialer:id/floating_action_button']")
	public static WebElement callericon;
